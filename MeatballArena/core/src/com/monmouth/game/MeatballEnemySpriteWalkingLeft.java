...
public class MeatballEnemySpriteWalkingLeft extends Sprite
{
    ...
    public MeatballEnemySpriteWalkingLeft()
    {
    	textureAtlas = new TextureAtlas(Gdx.files.internal("Enemies/enemy1walkingleft.atlas"));
